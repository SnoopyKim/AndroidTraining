...
public class MainActivity extends AppCompatActivity {
    ...
    public void scheduleJob(View view) {
        ...
        switch(selectedNetworkID) {
            case R.id.noNetwork:
                selectedNetworkOption = JobInfo.NETWORK_TYPE_NONE; break;
            case R.id.anyNetwork:
                selectedNetworkOption = JobInfo.NETWORK_TYPE_ANY; break;
            case R.id.wifiNetwork:
                selectedNetworkOption = JobInfo.NETWORK_TYPE_UNMETERED; break;
        }
        ...
        if (constraintSet) {
            // Schedule the job and modify the user
